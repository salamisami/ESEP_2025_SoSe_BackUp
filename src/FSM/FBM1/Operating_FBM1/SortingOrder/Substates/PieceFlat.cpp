...
void PieceFlat::exit() { PRINT_STATE; }

State *PieceFlat::clone() { return new PieceFlat(data); }
...
State *PieceFlat::reset_to_tall() { return new PieceTall(data); }

State *PieceFlat::com_reset_to_tall_w_metal() {
  return new PieceTallWithMetal(data);
}

State *PieceFlat::com_reset_to_tall() { return new PieceTall(data); }
