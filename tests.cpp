...
#define EXPECT_STATE_CONTAINS(expected_state)                                  \
  do {                                                                         \
    ...
    EXPECT_NE(is_state.find(expected_state), std::string::npos)                \
        << "Expected state to contain: '" << expected_state << "' but got: '"  \
        << is_state << "'";                                                    \
  } while (0)
...
template <typename InitialState> class LogicBaseTest : public ::testing::Test {
protected:
...
TEST_F(RealImplementationSetup, EStopViaComTest) {
  ...
  EXPECT_STATE_CONTAINS("WaitingIM");
  remote_control->send_event((int8_t)Topic::COM,
                             (int)COM_Enum::BUTTON_ESTOP_PRESSED);
...
/* TEST_F(PieceTrackerSetup, PieceTrackerTest){
    ...
    remote_control->send_event((int8_t) Topic::INTERNAL, (int)
Internal_Enum::NEW_PIECE); EXPECT_STATE("Start_PT1");
    remote_control->send_event((int8_t) Topic::INTERRUPT, (int)
InterruptEnum::LASER_FRONT_UNBLOCKED); EXPECT_STATE("StartADC_PT1");
}
    */
...
//     remote_control->send_event((int8_t) Topic::INTERRUPT, (int)
//     InterruptEnum::LASER_FRONT_BLOCKED); remote_control->send_event((int8_t)
//     Topic::INTERRUPT, (int) InterruptEnum::LASER_FRONT_UNBLOCKED);
//     WAIT(2000);
//     remote_control->send_event((int8_t) Topic::INTERRUPT, (int)
//     InterruptEnum::ADC_TOP_AREA_BLOCKED); WAIT(100);
//     remote_control->send_event((int8_t) Topic::INTERRUPT, (int)
//     InterruptEnum::ADC_TOP_AREA_UNBLOCKED); WAIT(1500);
//     remote_control->send_event((int8_t) Topic::INTERRUPT, (int)
//     InterruptEnum::LASER_SORTING_GATE_BLOCKED); WAIT(400);
//     remote_control->send_event((int8_t) Topic::INTERRUPT, (int)
//     InterruptEnum::LASER_SORTING_GATE_UNBLOCKED); WAIT(2000);
//     remote_control->send_event((int8_t) Topic::INTERRUPT, (int)
//     InterruptEnum::LASER_BACK_BLOCKED); WAIT(1000); auto distance =
//     data->piece_tracker->get_distance(); EXPECT_EQ(distance.first,
//     Area::GATE_END); EXPECT_GT(distance.second, 95);
// }
...
TEST_F(DeepHistorySetup, DeepHistoryTest) {
  ...
  remote_control->send_event((int8_t)Topic::INTERRUPT,
                             (int)InterruptEnum::BUTTON_STOP_RELEASED);
  WAIT(500);
  ...
  remote_control->send_event((int8_t)Topic::INTERRUPT,
                             (int)InterruptEnum::LASER_BACK_BLOCKED);
  EXPECT_STATE("Red");
  remote_control->send_event((int8_t)Topic::INTERRUPT,
...
TEST_F(RealImplementationSetup, PutNewPiece) {
    remote_control->send_event((int8_t) Topic::INTERRUPT, (int)
InterruptEnum::BUTTON_START_PRESSED); remote_control->send_event((int8_t)
Topic::INTERRUPT, (int) InterruptEnum::BUTTON_START_RELEASED);
    EXPECT_STATE_INSTANT("PieceControllerFBM1 Idle PieceFlat
StartingAreaUnblocked PieceAppearedNoError PieceLostNoError MQTTNoError
COMNoError ValidMeasure RampNoError CalibNoWarning ReplayNoWarning RampNotFull
NoRampFull"); DEBUG(">>>>>>>>>>>>>>>>>>>>>>>>>>> LASER FRONT BLOCKED
<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<"); remote_control->send_event((int8_t)
Topic::INTERRUPT, (int) InterruptEnum::LASER_FRONT_BLOCKED);
    EXPECT_STATE_INSTANT("Start_PT1 Fast PieceFlat StartingAreaBlocked
PieceAppearedNoError PieceLostNoError MQTTNoError COMNoError ValidMeasure
RampNoError CalibNoWarning ReplayNoWarning RampNotFull NoRampFull");

    DEBUG(">>>>>>>>>>>>>>>>>>>>>>>>>>> LASER FRONT UNBLOCKED
<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<"); remote_control->send_event((int8_t)
Topic::INTERRUPT, (int) InterruptEnum::LASER_FRONT_UNBLOCKED);
    EXPECT_STATE_INSTANT("StartADC_PT1 Fast PieceFlat StartingAreaBlocked
PieceAppearedNoError PieceLostNoError MQTTNoError COMNoError ValidMeasure
RampNoError CalibNoWarning ReplayNoWarning RampNotFull NoRampFull"); WAIT(2000);
    EXPECT_STATE_INSTANT("ADC_PT1 Slow PieceFlat StartingAreaUnblocked
PieceAppearedNoError PieceLostNoError MQTTNoError COMNoError ValidMeasure
RampNoError CalibNoWarning ReplayNoWarning RampNotFull NoRampFull");
    DEBUG(">>>>>>>>>>>>>>>>>>>>>>>>>>> ADC BEGIN
<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<"); remote_control->send_event((int8_t)
Topic::INTERRUPT, (int) InterruptEnum::ADC_TOP_AREA_BLOCKED);
    remote_control->send_event((int8_t) Topic::ADC, (int)
ADC_Enum::ADC_NEW_PIECE); WAIT(1123); DEBUG(">>>>>>>>>>>>>>>>>>>>>>>>>>> ADC END
<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<"); remote_control->send_event((int8_t)
Topic::ADC, (int) ADC_Enum::ADC_WF_DETECT); remote_control->send_event((int8_t)
Topic::INTERRUPT, (int) InterruptEnum::ADC_TOP_AREA_UNBLOCKED);
    EXPECT_STATE_INSTANT("ADCGate_PT1 Fast PieceFlat StartingAreaUnblocked
PieceAppearedNoError PieceLostNoError MQTTNoError COMNoError ValidMeasure
RampNoError CalibNoWarning ReplayNoWarning RampNotFull NoRampFull");
...
<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<"); remote_control->send_event((int8_t)
Topic::INTERRUPT, (int) InterruptEnum::LASER_SORTING_GATE_BLOCKED);
    EXPECT_STATE_INSTANT("LeavingGate_PT1 Fast PieceTall StartingAreaUnblocked
PieceAppearedNoError PieceLostNoError MQTTNoError COMNoError ValidMeasure
RampNoError CalibNoWarning ReplayNoWarning RampNotFull NoRampFull"); WAIT(400);
    remote_control->send_event((int8_t) Topic::INTERRUPT, (int)
InterruptEnum::LASER_SORTING_GATE_UNBLOCKED); DEBUG(">>>>>>>>>>>>>>>>>>>>>>>>>>>
LASER SORTING UNBLOCKED <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<"); WAIT(2000);
    DEBUG(">>>>>>>>>>>>>>>>>>>>>>>>>>> LASER BACK BLOCKED
<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<"); remote_control->send_event((int8_t)
Topic::INTERRUPT, (int) InterruptEnum::LASER_BACK_BLOCKED);
    EXPECT_STATE_INSTANT("PendingTransferRequest_PT1 Stop PieceTall
StartingAreaUnblocked PieceAppearedNoError PieceLostNoError MQTTNoError
COMNoError ValidMeasure RampNoError CalibNoWarning ReplayNoWarning RampNotFull
NoRampFull");
    ...
    DEBUG(">>>>>>>>>>>>>>>>>>>>>>>>>>> FBM 2 READY
<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<"); remote_control->send_event((int8_t)
Topic::COM, (int) COM_Enum::FBM_2_READY); EXPECT_STATE_INSTANT("Transfer_PT1
Fast PieceTall StartingAreaUnblocked PieceAppearedNoError PieceLostNoError
MQTTNoError COMNoError ValidMeasure RampNoError CalibNoWarning ReplayNoWarning
RampNotFull NoRampFull"); WAIT(1000); DEBUG(">>>>>>>>>>>>>>>>>>>>>>>>>>>
TRANSFER DONE <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<");
    remote_control->send_event((int8_t) Topic::COM, (int)
COM_Enum::TRANSFER_DONE);
    //WAIT(50); //TODO performance issue here
    EXPECT_STATE_INSTANT("PieceControllerFBM1 Idle PieceTall
StartingAreaUnblocked PieceAppearedNoError PieceLostNoError MQTTNoError
COMNoError ValidMeasure RampNoError CalibNoWarning ReplayNoWarning RampNotFull
NoRampFull");
}
...
ADC_Enum::ADC_NEW_PIECE); WAIT(1123); DEBUG(">>>>>>>>>>>>>>>>>>>>>>>>>>> ADC END
<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<"); remote_control->send_event((int8_t)
Topic::ADC, (int) ADC_Enum::ADC_W_B_DETECT); remote_control->send_event((int8_t)
Topic::INTERRUPT, (int) InterruptEnum::ADC_TOP_AREA_UNBLOCKED);
    EXPECT_STATE_INSTANT("ADCGate_PT1 Fast PieceFlat StartingAreaUnblocked
PieceAppearedNoError PieceLostNoError MQTTNoError COMNoError ValidMeasure
RampNoError CalibNoWarning ReplayNoWarning RampNotFull NoRampFull");
...
<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<"); remote_control->send_event((int8_t)
Topic::INTERRUPT, (int) InterruptEnum::LASER_SORTING_GATE_BLOCKED);
    EXPECT_STATE_INSTANT("SortingOut_PT1 Fast PieceFlat StartingAreaUnblocked
PieceAppearedNoError PieceLostNoError MQTTNoError COMNoError ValidMeasure
RampNoError CalibNoWarning ReplayNoWarning RampNotFull NoRampFull");
    //TODO still wrong
...
<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<"); remote_control->send_event((int8_t)
Topic::INTERRUPT, (int) InterruptEnum::LASER_RAMP_BLOCKED);
    //WAIT(100); //TODO performance issue here
    EXPECT_STATE_INSTANT("PieceControllerFBM1 Idle PieceFlat
StartingAreaUnblocked PieceAppearedNoError PieceLostNoError MQTTNoError
COMNoError ValidMeasure RampNoError CalibNoWarning ReplayNoWarning RampTimer
NoRampFull");
}
    */
...
TEST_F(RealImplementationSetup, ServiceModeFullTest) {
  ...
  remote_control->send_event((int8_t)Topic::INTERRUPT,
                             (int)InterruptEnum::BUTTON_START_RELEASED);
  EXPECT_STATE(
      "IdleSM PieceAppearedNoError PieceLostNoError MQTTNoError COMNoError "
      "ValidMeasure RampNoError CalibNoWarning ReplayNoWarning");

  // put a piece to calibrate the pieces
  remote_control->send_event((int8_t)Topic::INTERRUPT,
                             (int)InterruptEnum::LASER_FRONT_BLOCKED);
  remote_control->send_event((int8_t)Topic::INTERRUPT,
                             (int)InterruptEnum::LASER_FRONT_UNBLOCKED);
  EXPECT_STATE(
      "IdleSMSR IdleSTR PieceAppearedNoError PieceLostNoError MQTTNoError "
      "COMNoError ValidMeasure RampNoError CalibNoWarning ReplayNoWarning");

  // //piece goes to sorting gate
  remote_control->send_event((int8_t)Topic::INTERRUPT,
                             (int)InterruptEnum::LASER_SORTING_GATE_BLOCKED);
  remote_control->send_event((int8_t)Topic::INTERRUPT,
                             (int)InterruptEnum::LASER_SORTING_GATE_UNBLOCKED);
  remote_control->send_event((int8_t)Topic::INTERRUPT,
                             (int)InterruptEnum::LASER_RAMP_BLOCKED);
  remote_control->send_event((int8_t)Topic::INTERRUPT,
                             (int)InterruptEnum::LASER_RAMP_UNBLOCKED);
  EXPECT_STATE(
      "IdleSMSR IdleSTR PieceAppearedNoError PieceLostNoError MQTTNoError "
      "COMNoError ValidMeasure RampNoError CalibNoWarning ReplayNoWarning");

  // //assume calibration is done
  remote_control->send_event((int8_t)Topic::ADC,
                             (int)ADC_Enum::ADC_CALIBRATION_DONE);
  ...
  remote_control->send_event((int8_t)Topic::INTERRUPT,
                             (int)InterruptEnum::LASER_RAMP_UNBLOCKED);
  EXPECT_STATE(
      "ReadyForCDF PieceAppearedNoError PieceLostNoError MQTTNoError "
      "COMNoError ValidMeasure RampNoError CalibNoWarning ReplayNoWarning");
  ...
  remote_control->send_event((int8_t)Topic::INTERRUPT,
                             (int)InterruptEnum::LASER_FRONT_UNBLOCKED);
  EXPECT_STATE(
      "StartCDF IdleLPT PieceAppearedNoError PieceLostNoError MQTTNoError "
      "COMNoError ValidMeasure RampNoError CalibNoWarning ReplayNoWarning");
  WAIT(2000);
  remote_control->send_event((int8_t)Topic::INTERRUPT,
                             (int)InterruptEnum::ADC_TOP_AREA_BLOCKED);
  WAIT(1000);
  remote_control->send_event((int8_t)Topic::INTERRUPT,
                             (int)InterruptEnum::ADC_TOP_AREA_UNBLOCKED);
  WAIT(1000);
  ...
  remote_control->send_event((int8_t)Topic::INTERRUPT,
                             (int)InterruptEnum::LASER_BACK_BLOCKED);
  EXPECT_STATE("EndToGateCRF PusherIdleCRF PieceAppearedNoError "
               "PieceLostNoError MQTTNoError COMNoError ValidMeasure "
               "RampNoError CalibNoWarning ReplayNoWarning");

  // the piece goes back
  remote_control->send_event((int8_t)Topic::INTERRUPT,
                             (int)InterruptEnum::LASER_BACK_UNBLOCKED);
  WAIT(3000);
  remote_control->send_event((int8_t)Topic::INTERRUPT,
                             (int)InterruptEnum::LASER_SORTING_GATE_BLOCKED);
  WAIT(1000);
  ...
  remote_control->send_event((int8_t)Topic::INTERRUPT,
                             (int)InterruptEnum::LASER_RAMP_UNBLOCKED);
  EXPECT_STATE(
      "ReadyForCDS PieceAppearedNoError PieceLostNoError MQTTNoError "
      "COMNoError ValidMeasure RampNoError CalibNoWarning ReplayNoWarning");
  ...
  remote_control->send_event((int8_t)Topic::INTERRUPT,
                             (int)InterruptEnum::LASER_FRONT_UNBLOCKED);
  EXPECT_STATE(
      "StartCDS IdleLPT PieceAppearedNoError PieceLostNoError MQTTNoError "
      "COMNoError ValidMeasure RampNoError CalibNoWarning ReplayNoWarning");
  WAIT(2000);
  remote_control->send_event((int8_t)Topic::INTERRUPT,
                             (int)InterruptEnum::ADC_TOP_AREA_BLOCKED);
  ...
  remote_control->send_event((int8_t)Topic::INTERRUPT,
                             (int)InterruptEnum::LASER_BACK_BLOCKED);
  EXPECT_STATE("EndToGateCRS PusherIdleCRS PieceAppearedNoError "
               "PieceLostNoError MQTTNoError COMNoError ValidMeasure "
               "RampNoError CalibNoWarning ReplayNoWarning");
  ...
  remote_control->send_event((int8_t)Topic::INTERRUPT,
                             (int)InterruptEnum::LASER_RAMP_UNBLOCKED);
  EXPECT_STATE(
      "CalibrationFinished PieceAppearedNoError PieceLostNoError MQTTNoError "
      "COMNoError ValidMeasure RampNoError CalibNoWarning ReplayNoWarning");
}
...
//     //go to service mode
//     remote_control->send_event((int8_t) Topic::INTERRUPT, (int)
//     InterruptEnum::BUTTON_START_PRESSED); WAIT(2100);
//     remote_control->send_event((int8_t) Topic::INTERRUPT, (int)
//     InterruptEnum::BUTTON_START_RELEASED); EXPECT_STATE("IdleSM");
...
//     // //piece goes to sorting gate
//     remote_control->send_event((int8_t) Topic::INTERRUPT, (int)
//     InterruptEnum::LASER_SORTING_GATE_BLOCKED);
//     remote_control->send_event((int8_t) Topic::INTERRUPT, (int)
//     InterruptEnum::LASER_SORTING_GATE_UNBLOCKED);
//     remote_control->send_event((int8_t) Topic::INTERRUPT, (int)
//     InterruptEnum::LASER_RAMP_BLOCKED); remote_control->send_event((int8_t)
//     Topic::INTERRUPT, (int) InterruptEnum::LASER_RAMP_UNBLOCKED);
//     EXPECT_STATE("IdleSMSR IdleSTR");

//     remote_control->send_event((int8_t) Topic::INTERRUPT, (int)
//     InterruptEnum::BUTTON_ESTOP_PRESSED); EXPECT_STATE("EStopViaLocal");
//     remote_control->send_event((int8_t) Topic::INTERRUPT, (int)
//     InterruptEnum::BUTTON_ESTOP_RELEASED); EXPECT_STATE("EStopReleased");
//     remote_control->send_event((int8_t) Topic::INTERRUPT, (int)
//     InterruptEnum::BUTTON_RESET_PRESSED); remote_control->send_event((int8_t)
//     Topic::INTERRUPT, (int) InterruptEnum::BUTTON_RESET_RELEASED);
//     EXPECT_STATE("WaitingForComReset");
//     remote_control->send_event((int8_t) Topic::COM, (int)
//     COM_Enum::BUTTON_RESET_PRESSED); EXPECT_STATE("IdleIM");
// }
...
//     EXPECT_STATE("IdleIM PieceAppearedNoError PieceLostNoError MQTTNoError
//     COMNoError ValidMeasure RampNoError CalibNoWarning ReplayNoWarning
//     RampNotFull NoRampFull");
//     //go to service mode
//     remote_control->send_event((int8_t) Topic::INTERRUPT, (int)
//     InterruptEnum::BUTTON_START_PRESSED); EXPECT_STATE("WaitingIM
//     PieceAppearedNoError PieceLostNoError MQTTNoError COMNoError ValidMeasure
//     RampNoError CalibNoWarning ReplayNoWarning RampNotFull NoRampFull");
//     WAIT(500);
//     remote_control->send_event((int8_t) Topic::INTERRUPT, (int)
//     InterruptEnum::BUTTON_START_RELEASED); EXPECT_STATE("PieceControllerFBM1
//     Idle PieceFlat StartingAreaUnblocked PieceAppearedNoError
//     PieceLostNoError MQTTNoError COMNoError ValidMeasure RampNoError
//     CalibNoWarning ReplayNoWarning RampNotFull NoRampFull");
//     remote_control->send_event((int8_t) Topic::INTERRUPT, (int)
//     InterruptEnum::BUTTON_STOP_PRESSED); remote_control->send_event((int8_t)
//     Topic::INTERRUPT, (int) InterruptEnum::BUTTON_STOP_RELEASED);
//     EXPECT_STATE("IdleIM PieceAppearedNoError PieceLostNoError MQTTNoError
//     COMNoError ValidMeasure RampNoError CalibNoWarning ReplayNoWarning
//     RampNotFull NoRampFull");
// }
...
//     EXPECT_STATE("IdleIM PieceAppearedNoError PieceLostNoError MQTTNoError
//     COMNoError ValidMeasure RampNoError CalibNoWarning ReplayNoWarning
//     RampNotFull NoRampFull"); remote_control->send_event((int8_t)
//     Topic::INTERRUPT, (int) InterruptEnum::BUTTON_START_PRESSED);
//     EXPECT_STATE("WaitingIM PieceAppearedNoError PieceLostNoError MQTTNoError
//     COMNoError ValidMeasure RampNoError CalibNoWarning ReplayNoWarning
//     RampNotFull NoRampFull"); WAIT(2100); EXPECT_STATE("TimerReceivedIM
//     PieceLostNoError MQTTNoError COMNoError ValidMeasure RampNoError
//     CalibNoWarning ReplayNoWarning RampNotFull NoRampFull");
//     remote_control->send_event((int8_t) Topic::INTERRUPT, (int)
//     InterruptEnum::BUTTON_START_RELEASED); EXPECT_STATE("ServiceMode
//     PieceLostNoError MQTTNoError COMNoError ValidMeasure RampNoError
//     CalibNoWarning ReplayNoWarning RampNotFull NoRampFull");
//     remote_control->send_event((int8_t) Topic::INTERRUPT, (int)
//     InterruptEnum::BUTTON_STOP_PRESSED); remote_control->send_event((int8_t)
//     Topic::INTERRUPT, (int) InterruptEnum::BUTTON_STOP_RELEASED);
//     EXPECT_STATE("IdleIM Idle PieceFlat StartingAreaUnblocked
//     PieceAppearedNoError PieceLostNoError MQTTNoError COMNoError ValidMeasure
//     RampNoError CalibNoWarning ReplayNoWarning RampNotFull NoRampFull");
// }
...
TEST_F(MotorControlSetup, MotorControlWorkpieceTrackingTest) {
  ...
  // Test MOTOR_SLOW with workpiece ID 2 - should transition to Slow and update
  // all to SLOW
  ...
  // Test MOTOR_STOP_FSM with workpiece ID 3 - should transition to Stop and
  ...
  // Test DELETE_W_MOTOR with specific ID - should stay in Stop (workpieces
  // remain)
  remote_control->send_event((int8_t)Topic::DELETE_W_MOTOR, 2); // Remove ID 2
  WAIT(10);
  EXPECT_FALSE(data->workpieceList.contains(2));
  ...
  WAIT(10);
  EXPECT_STATE("Stop"); // Still has workpieces
  EXPECT_EQ(static_cast<int>(data->current_motor_speed), 2);
  ...
  remote_control->send_event((int8_t)Topic::DELETE_W_MOTOR,
                             4); // Remove last workpiece
  WAIT(10);
...
TEST_F(MotorControlSetup, WorkpieceLifecycleTest) {
  // Start in Idle state (empty system)
  EXPECT_STATE("Idle");
  EXPECT_EQ(static_cast<int>(data->current_motor_speed), 2); // STOPPED
  ...
  // 2. System slows down -> SLOW (motor_slowed=true)
  remote_control->send_event((int8_t)Topic::MOTOR_SLOW, 100);
  WAIT(10);
  EXPECT_STATE("Slow");
  EXPECT_EQ(static_cast<int>(data->current_motor_speed), 1); // SLOW
  EXPECT_FALSE(data->motor_stopped);
  EXPECT_TRUE(data->motor_slowed); // New requirement check
  EXPECT_EQ(data->workpieceList.getState(100), MotorPieceState::SLOW);
  EXPECT_EQ(data->workpieceList.size(), 1);

  // 3. System needs to stop -> STOPPED (motor_stopped=true, overrides slow)
  remote_control->send_event((int8_t)Topic::MOTOR_STOP_FSM, 100);
  WAIT(10);
  EXPECT_STATE("Stop");
  EXPECT_EQ(static_cast<int>(data->current_motor_speed), 2); // STOPPED
  EXPECT_TRUE(data->motor_stopped);                          // New requirement
  EXPECT_FALSE(data->motor_slowed); // STOP overrides SLOW
  EXPECT_EQ(data->workpieceList.getState(100), MotorPieceState::STOPPED);

  // 4. System resumes -> FAST (no pending requests)
  remote_control->send_event((int8_t)Topic::MOTOR_FAST, 100);
  WAIT(10);
  EXPECT_STATE("Fast");
  EXPECT_EQ(data->workpieceList.size(), 1);
  ...
  // 5. Workpiece leaves system -> DELETE (back to Idle)
  ...
  // --- Multi-Workpiece Priority Test ---
  // Add two workpieces: 200 (SLOW) and 300 (FAST)
  remote_control->send_event((int8_t)Topic::MOTOR_SLOW, 200);
  WAIT(10);
  remote_control->send_event((int8_t)Topic::MOTOR_FAST, 300);
  WAIT(10);
  EXPECT_EQ(data->workpieceList.size(), 2);
  EXPECT_STATE("Slow"); // 200's SLOW request dominates
  EXPECT_TRUE(data->motor_slowed);
  EXPECT_FALSE(data->motor_stopped);

  // Add STOP request for 300 -> system should STOP
  remote_control->send_event((int8_t)Topic::MOTOR_STOP_FSM, 300);
  WAIT(10);
  EXPECT_STATE("Stop"); // STOP overrides SLOW
  EXPECT_TRUE(data->motor_stopped);
  EXPECT_EQ(data->workpieceList.size(), 2);
  EXPECT_TRUE(data->motor_slowed);

  // Delete stopped workpiece 300 -> should revert to SLOW (200 still exists)
  remote_control->send_event((int8_t)Topic::DELETE_W_MOTOR, 300);
  WAIT(10);
  EXPECT_FALSE(data->workpieceList.contains(300));
  EXPECT_FALSE(data->workpieceList.contains(100));
  EXPECT_TRUE(data->workpieceList.contains(200));
  EXPECT_EQ(data->workpieceList.size(), 1);
  EXPECT_STATE("Slow");
  EXPECT_FALSE(data->motor_stopped);
  EXPECT_TRUE(data->motor_slowed); // 200 still requires SLOW

  // Delete last workpiece -> Idle
  remote_control->send_event((int8_t)Topic::DELETE_W_MOTOR, 200);
  WAIT(10);
  EXPECT_STATE("Idle");
  EXPECT_FALSE(data->motor_stopped);
  EXPECT_FALSE(data->motor_slowed);
...
TEST_F(MotorControlSetup, MultipleWorkpiecesOverlappingTest) {
  ...
  remote_control->send_event((int8_t)Topic::MOTOR_SLOW,
                             203); // This should change ALL to SLOW
  WAIT(10);
  EXPECT_STATE("Slow");
  EXPECT_EQ(static_cast<int>(data->current_motor_speed), 1); // SLOW
  ...
  // Change to STOPPED
  remote_control->send_event((int8_t)Topic::MOTOR_STOP_FSM,
                             205); // Add new and change all
  WAIT(10);
  EXPECT_STATE("Stop");
  EXPECT_EQ(static_cast<int>(data->current_motor_speed), 2); // STOPPED
...
TEST_F(CalibrationFileWarningHandlerSetup, CalibrationWarningTest) {
  ...
  remote_control->send_event((int8_t)Topic::ERROR,
                             (int)Error_Enum::CANT_FIND_CALB_CONF);
...
/**
 * @brief testet Übergägne der Zustände von "COMErrorHandler" mit quittierung
 * des Fehlers
 */
TEST_F(COMErrorHandlerSetup, COMErrorTest) {
  // teste
  remote_control->send_event((int8_t)Topic::ERROR,
                             (int)Error_Enum::ERROR_C_LOST_COM);
...
/**
 * @brief testet Übergägne der Zustände von "COMErrorHandler" ohne quittierung
 * des Fehlers
 */
...
/**
 * @brief testet Übergägne der Zustände von "InvalidMeasurementHandle" mit
 * quittierung des Fehlers
 */
TEST_F(InvalidMeasurementHandlerSetup, InvalidMeasurementTest) {
  // teste
  remote_control->send_event((int8_t)Topic::ADC,
                             (int)ADC_Enum::ADC_INVALID_MESURE);
...
/**
 * @brief testet Übergägne der Zustände von "InvalidMeasurementHandle" ohne
 * quittierung des Fehlers
 */
...
/**
 * @brief testet Übergägne der Zustände von "MQTTErrorHandler" mit quittierung
 * des Fehlers
 */
TEST_F(MQTTErrorHandlerSetup, MQTTErrorTest) {
  // teste
  remote_control->send_event((int8_t)Topic::ERROR,
                             (int)Error_Enum::ERROR_C_LOST_MQTT);
  EXPECT_STATE("MQTTFehlerUnquittiert");
  remote_control->send_event((int8_t)Topic::INTERRUPT,
                             (int)InterruptEnum::BUTTON_RESET_RELEASED);
  EXPECT_STATE("MQTTFehlerQuittiert");
  remote_control->send_event((int8_t)Topic::REM_CON,
                             (int)RemoteControlEnum::MQTT_CONNECTED);
...
/**
 * @brief testet Übergägne der Zustände von "MQTTErrorHandler" ohne quittierung
 * des Fehlers
 */
...
/**
 * @brief testet Übergägne der Zustände von "PieceAppearedHandler" mit
 * quittierung des Fehlers
 */
...
/**
 * @brief testet Übergägne der Zustände von "RampErrorHandler" mit quittierung
 * des Fehlers
 */
TEST_F(RampErrorHandlerSetup, RampErrorTest) {
  ...
  remote_control->send_event((int8_t)Topic::INTERNAL,
                             (int)Internal_Enum::RAMP_NOT_FULL);
...
/**
 * @brief testet Übergägne der Zustände von "RampErrorHandler" ohne quittierung
 * des Fehlers
 */
...
/**
 * @brief testet Übergägne via COM-Events der Zustände von "RampErrorHandler"
...
//     double position = 80;
//     data->piece_FBM2_soll->piece_tracker->update_distance_force(Area::START_ADC,
//     position); WAIT(110); EXPECT_STATE_INSTANT("ADC");
//     remote_control->send_event((int8_t)Topic::ADC,
//     (int)ADC_Enum::ADC_NEW_PIECE); EXPECT_STATE_INSTANT("Measuring");
//     remote_control->send_event((int8_t)Topic::ADC,
//     (int)ADC_Enum::ADC_WH_DETECT); EXPECT_STATE_INSTANT("ADC_Gate");
//     data->piece_FBM2_soll->piece_tracker->update_distance_force(Area::ADC_GATE,
//     position);
//     data->piece_FBM2_ist->piece_tracker->update_distance_force(Area::ADC_GATE,
//     position); data->piece_FBM2_ist->piece_tracker->fast();
//     remote_control->send_event((int8_t) Topic::INTERRUPT, (int)
//     InterruptEnum::LASER_SORTING_GATE_BLOCKED); EXPECT_STATE_INSTANT("Gate");
//     remote_control->send_event((int8_t) Topic::INTERNAL, (int)
//     Internal_Enum::LET_THROUGH); EXPECT_STATE_INSTANT("Gate_End");
//     data->piece_FBM2_soll->piece_tracker->update_distance_force(Area::GATE_END,
//     position); remote_control->send_event((int8_t) Topic::INTERRUPT, (int)
//     InterruptEnum::LASER_BACK_BLOCKED); EXPECT_STATE_INSTANT("End");
//     remote_control->send_event((int8_t) Topic::INTERRUPT, (int)
//     InterruptEnum::LASER_BACK_UNBLOCKED);
